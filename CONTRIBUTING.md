...
- [Open an
  issue](https://github.com/puppetlabs/puppetlabs-gcloud_inventory/issues/new/choose)
  or [track an
  issue](https://github.com/puppetlabs/puppetlabs-gcloud_inventory/issues) you are
  patching.
...
- [Open a Pull
  Request](https://github.com/puppetlabs/puppetlabs-gcloud_inventory/compare)
